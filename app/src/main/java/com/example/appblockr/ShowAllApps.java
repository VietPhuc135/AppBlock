    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(ShowAllApps.this, MainActivity.class);
                ShowAllApps.this.startActivity(myIntent);
            }
        });*/
            ...
            if (!packageName.matches("com.robocora.appsift|com.android.settings")) {
                if (!prefLockedAppList.isEmpty()) {
                    ...
                    if (prefLockedAppList.contains(packageName)) {
                        apps.add(new AppModel(name, icon, 1, packageName)); //tình trạng đã khóa
                    } else {
                        apps.add(new AppModel(name, icon, 0, packageName)); //tình trạng chưa khóa
                    }
                } else {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                for (AppModel app : apps) {
                    if (app.getAppName().toLowerCase().contains(userInput)) { //so sánh tên app với mình nhập
                        newList.add(app);
                    }
                }
