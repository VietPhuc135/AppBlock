...
public class LockedAppAdapter extends RecyclerView.Adapter<LockedAppAdapter.adapter_design_backend> {
    ...
    @Override
    //tìm nạp và sử dụng dữ liệu điền vào bố cục của chế độ người xem
    ...
    @Override
    //lấy kích thước tệp tin, xác định khi nào không thể hiện thị dữ liệu nữa
